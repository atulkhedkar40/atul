...
jH=168## assumption, factor for heat transfer,dimensionless
...
deltw =(tw -Tcsoln[-1])
Av=(qv/6.0)## heat transfer for vapourization
As=qs/60## heat transfer surface
A1=As+Av## total area
ho=(Q/A1)## heat transfer coefficient for outer fluid
...
UD=((Q)/((A)*(tw)))## actual design  overall coeffcient,Btu/hr.ft^2.F
